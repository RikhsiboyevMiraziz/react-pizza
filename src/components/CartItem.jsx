...
import { clearAlike, minusPizza, plusPizza } from '../redux/actions/cart'

const CartItem = ({index, name, img, size, type, alikeCount, alikePrice}) => {
    ...
    return (
        <div className="cart__item">
            ...
            <div className="cart__item-remove" onClick={clear}>
